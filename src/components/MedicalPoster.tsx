  ...
  const procedures = [
    {
      ...
      content: [
        ...
        "Consejos dietéticos:",
        "Primeros días: dieta blanda y fácil de tragar (purés, sopas, yogures, batidos).",
        "Evitar alimentos muy calientes, picantes o irritantes si hay molestias al tragar.",
        "Mantener una buena hidratación con agua o infusiones suaves.",
        "Mantener una dieta variada rica en proteínas (carnes, huevos, legumbres) para favorecer la cicatrización.",
        "",
        "2.- Cuidados de la herida.",
        "Mantener la herida limpia y seca.",
        "Lavar alrededor con agua y jabón neutro",
        "Aplicar clorhexidina, evitar yodo.",
        "Secar la zona dando toques suaves con una toalla limpia.",
        "No retirar puntos o tiras de aproximación hasta indicación médica.",
        "Evitar exponerse al sol directo por al menos 6 meses (usar protector solar o cubrir la zona con ropa liviana).",
        "Evitar roces o presión: No colocar ropa ajustada que pueda presionar la herida ni manipularla. Usar ropa suave y holgada alrededor del cuello.",
        "",
        "3.- Recomendaciones",
        "Tomar la medicación prescrita (analgésicos, antibióticos, hormona tiroidea si aplica) exactamente como lo indicó el médico",
        "Reposo relativo durante los primeros 7 a 10 días.",
        "Debe pasear a diario.",
        "Dormir con la cabeza ligeramente elevada (2 almohadas) para reducir inflamación y molestias.",
