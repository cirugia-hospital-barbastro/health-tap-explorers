...
const MedicalPoster = () => {
  ...
  const postOperativeData = {
    ...
    content: [
      ...
      "⚠️ Un líquido <u>bilioso</u>, espeso y de color verdoso o amarillo intenso puede indicar una FUGA BILIAR.",
      "⚠️ Si el líquido es cada vez más <u>rojo</u> y más <u>productivo</u>, puede indicar HEMORRAGIA. Si produce > 300 cc en las primeras 3 horas postIQ, avisar a CIR de guardia.",
      "⚠️ Una secreción <u>purulenta</u> puede indicar INFECCION.",
      "⚠️ Un contenido <u>fecaloideo</u> indica FUGA o PERFORACIÓN GASTROINTESTINAL.",
      ...
      "<span style='margin-left: 2rem; display: block;'>* Tener en cuenta el horario de administración de la hbpm respecto a la colocación y retirada del catéter según los protocolos establecidos.</span>",
      "<span style='margin-left: 2rem; display: block;'>* NUNCA administrar otra medicación por esta vía.</span>",
      ...
      "<span style='margin-left: 2rem; display: block;'>* En caso de mal control del dolor o incidencias con el catéter, comentar con anestesista de guardia.</span>",
