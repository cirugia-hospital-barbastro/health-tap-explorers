...
const MedicalPoster = () => {
  ...
  const postOperativeData = {
    ...
    content: [
      ...
      "<span style='margin-left: 2rem; display: block;'>⚠️ Si el líquido es cada vez más <u>rojo</u> y más <u>productivo</u>, puede indicar HEMORRAGIA. Si produce > 300 cc en las primeras 3 horas postIQ, avisar a CIR de guardia.</span>",
  ...
  const procedures = [
    {
      ...
      content: [
        ...
        "- Reposo de la voz.",
        "- Vigilar signos de hematoma cervical.",
        ...
        "",
        "<strong>RECOMENDACIONES AL ALTA:</strong>",
        "",
        "<em>Consejos dietéticos:</em>",
        ...
        "",
        "<em>Cuidados de la herida:</em>",
        "- La herida debe estar siempre limpia y seca.",
        "- Durante su higiene diaria, lave alrededor de la herida con agua y jabón neutro. Secar la zona dando toques suaves con una toalla limpia.",
        ...
        "- Guarde reposo relativo durante los primeros 7 a 10 días. Debe pasear a diario.",
        ...
        "- Es común tener ligera ronquera o molestias al hablar los primeros días. No forzar la voz ni gritar.",
        "",
        "<em>Signos de alarma:</em>",
    ...
    },
    {
      ...
      content: [
        ...
        "- En caso de CIRUGÍA LAPAROSCÓPICA, la presencia de gases es habitual. Pueden provocar dolor irradiado hacia el hombro derecho, la mejor manera de disminuirlos es la incorporación y deambulación.",
        "- ⚠️ Al iniciar la tolerancia oral, la DIETA deberá ser <u>fraccionada</u>, tomando los líquidos fuera de las ingestas. <u>Evitar la leche</u>.",
