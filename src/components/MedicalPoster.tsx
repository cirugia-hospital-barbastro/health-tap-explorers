...
const MedicalPoster = () => {
  const preAdmissionData = {
    ...
    content: [
      ...
      "Comprobación de <u>órdenes pre-quirúrgicas</u> en <u>Informe de Evaluación Pre-anestésica</u> (formularios). <strong>Verificar suspensión de anticoagulantes, antidiabéticos, …</strong> .",
