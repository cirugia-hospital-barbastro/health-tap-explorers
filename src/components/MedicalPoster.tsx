  ...
  const procedures = [
    ...
    },
    {
      ...
      content: [
        ...
        "- En caso de CIRUGÍA LAPAROSCÓPICA, la presencia de gases es habitual. Pueden provocar dolor irradiado hacia el hombro derecho, la mejor manera de disminuirlos es la incorporación y deambulación.",
        "- ⚠️ Al iniciar la tolerancia oral, la DIETA deberá ser siempre <u>FRACCIONADA</u> y mantener dieta <u>semiblanda</u> o <u>triturada</u> las primeras semanas. <u>Evitar la leche</u>.",
        "En GASTRECTOMÍA, además se tomarán los <u>líquidos fuera de las ingestas</u>.",
