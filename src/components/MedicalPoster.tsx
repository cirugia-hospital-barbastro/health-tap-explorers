  ...
  const procedures = [
    ...
    },
    {
      ...
      content: [
        ...
        "  Si produce > 300 cc en las primeras 3 horas postIQ, avisar a CIR de guardia.",
        "  Un líquido bilioso, espeso y de color verdoso o amarillo intenso puede indicar una fuga biliar.",
        "  Si el líquido es cada vez más rojo y más productivo, puede indicar hemorragia.",
